...
----
npx degit github:enonic/nextxp-template
----
...
If Next boots without errors, point your browser to http://localhost:3000/hmdb[http://localhost:3000/hmdb^] to see the glorious result.
...
The URL structure of your front-end will mirror the structure of the content in the CMS. http://localhost:3000/hmdb[http://localhost:3000/hmdb^] will be mounted to the site root, which in our case has the internal path `/hmdb`.

Using the Movie Se7en as an example:

.Result when visiting http://localhost:3000/hmdb/movies/se7en[http://localhost:3000/hmdb/movies/se7en^]
[source]
----
Page:
{
...
* http://localhost:3000/hmdb/movies[http://localhost:3000/hmdb/movies^] +
* http://localhost:3000/hmdb/persons[http://localhost:3000/hmdb/persons^] +
* http://localhost:3000/hmdb/persons/brad-pitt[http://localhost:3000/hmdb/persons/brad-pitt^]
