...
. **Verify** by pointing your *incognito window* to http://localhost:3000/hmdb[http://localhost:3000/hmdb^], you should now see the published items, just like in dev mode.
...
The page should now get updated at http://localhost:3000/hmdb[http://localhost:3000/hmdb^] - more or less instantly.🎉
