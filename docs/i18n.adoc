...
+
Finally, by adding `/no/hmdb` (i.e. `localhost:3000/no/hmdb`) to the URL of your Next.js server in an *incognito window* you should now see the published content from the Norwegian project.
